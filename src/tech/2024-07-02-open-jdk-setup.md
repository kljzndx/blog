...
于是我就搜索了下 openjdk 以便寻找下载地址，翻了几页之后发现有两个网站可以下载，一个是微软，另一个是红帽。然而在红帽这边下载是需要注册账号的，而微软那边则可以直接下载，所以我就下了[微软构建的版本](https://learn.microsoft.com/zh-cn/java/openjdk/download)。

### 配置

#### 环境变量

接下来就是要配置坏境变量，对于程序员来说这应该算是基本功了
